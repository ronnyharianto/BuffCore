...
{
    /// <summary>
    /// Configuration settings related to cloud storage services.
    /// </summary>
    public class StorageConfig
    {
        ...
        /// </summary>
        public GoogleCloudStorage GoogleCloudStorage { get; set; } = new();
    }
    ...
    public class GoogleCloudStorage
    {
        ...
        /// </summary>
        public GoogleServiceAccount ServiceAccount { get; set; } = new();
    }
}
