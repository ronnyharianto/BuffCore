...
{
    /// <summary>
    /// Helper methods for working with enums: description retrieval, description-based filtering,
    /// and enumeration of values with their metadata as <see cref="Abstractions.Dtos.EnumDto"/>.
    /// </summary>
    public static class EnumHelper
    {
        ...
        /// <returns>A list of <see cref="Abstractions.Dtos.EnumDto"/> objects representing each enum value and description.</returns>
        public static List<Abstractions.Dtos.EnumDto> RetrieveEnumList<TEnum>()
            where TEnum : Enum
        {
            var result = new List<Abstractions.Dtos.EnumDto>();
        ...
        /// <returns>A list of <see cref="Abstractions.Dtos.EnumDto"/> including the enum value, description, and mapped value if available.</returns>
        public static List<Abstractions.Dtos.EnumDto> RetrieveEnumList<TEnum, TMapFromEnum>()
            where TEnum : Enum
