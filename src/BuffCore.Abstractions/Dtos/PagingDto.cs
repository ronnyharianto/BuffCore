...
namespace BuffCore.Abstractions.Dtos
{
        ...
        where T : class
    {
        ...
        public async Task ApplyPagination(int page, int pageSize, IQueryable<T>? obj, CancellationToken cancellationToken, string? message = null)
        {
            ...
            {
                RecordsFiltered = obj.Provider is IAsyncQueryProvider ? await obj.CountAsync(cancellationToken) : obj.Count();
